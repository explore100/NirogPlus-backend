...
router.post('/appoinments', authenticateToken, authorizeRoles('customer'), async (req, res) => {
  const { userId, doctor, reason, scheduled } = req.body;
  if (!userId || !doctor || !reason || !scheduled) {
